...
EMSTATUS PAL_SpiInit(void) {
  ...
  PAL_SPI_USART_UNIT->ROUTEPEN = USART_ROUTEPEN_TXPEN | USART_ROUTEPEN_CLKPEN;
  PAL_SPI_USART_UNIT->ROUTELOC0 =
      (PAL_SPI_USART_UNIT->ROUTELOC0 &
...
#else
  PAL_SPI_USART_UNIT->ROUTE =
      (USART_ROUTE_CLKPEN | USART_ROUTE_TXPEN | PAL_SPI_USART_LOCATION);
#endif
...
/**************************************************************************/ /**
                                                                              ...
                                                                              * @return  EMSTATUS code of the operation.
                                                                              *****************************************************************************/
EMSTATUS PAL_TimerRepeat(void (*pFunction)(void *), void *argument,
...
/***************************************************************************/ /**
                                                                               ...
                                                                               * @return  EMSTATUS code of the operation.
                                                                               ******************************************************************************/
EMSTATUS PAL_GpioPinModeSet(unsigned int port, unsigned int pin,
                            PAL_GpioMode_t mode,
...
/**************************************************************************/ /**
                                                                              ...
                                                                              * @return  EMSTATUS code of the operation.
                                                                              *****************************************************************************/
EMSTATUS PAL_GpioPinAutoToggle(unsigned int gpioPort, unsigned int gpioPin,
                               unsigned int frequency) {
  ...
  PRS_PinOutput(LCD_AUTO_TOGGLE_PRS_CH, prsTypeAsync,
                (GPIO_Port_TypeDef)gpioPort, gpioPin);
#elif defined(_SILICON_LABS_32B_SERIES_1)
  LCD_AUTO_TOGGLE_PRS_ROUTELOC();
  PRS->ROUTEPEN |= LCD_AUTO_TOGGLE_PRS_ROUTEPEN;
#else
  PRS->ROUTE =
      (PRS->ROUTE & ~_PRS_ROUTE_LOCATION_MASK) | LCD_AUTO_TOGGLE_PRS_ROUTE_LOC;
...
static void rtcSetup(unsigned int frequency) {
  ...
  /* Initialize RTC */
  rtcInit.enable =
      false; /* Do not start RTC after initialization is complete. */
